...
class LaporanBuku extends StatefulWidget {
  @override
  State<LaporanBuku> createState() => _LaporanBukuState();
}

class _LaporanBukuState extends State<LaporanBuku> {
                        ...
                        subtitle: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              if (book['nama_instansi'] != null)
                                Text(
                                    'Peminjam: ${book['nama_instansi'] ?? 'Nama instansi tidak ada'}'),
                            ],
                          ),
                        ),
                        trailing: IconButton(
                          ...
                          onPressed: () =>
                              _confirmDelete(book['id'].toString()),
                        ),
                      ),
                      Divider(
