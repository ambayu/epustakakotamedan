...
class LaporanController extends GetxController {
  ...
  Future<void> fetchBooks({bool isNext = true}) async {
    ...
    if (selectedValue == '1') {
      endpoint = '/baca-ditempat/laporan-masuk';
    } else if (selectedValue == '2') {
      endpoint = '/pencatatan-manual-instansi/laporan-masuk';
    } else {
      endpoint =
          '/baca-ditempat/laporan-masuk'; // Tambahkan endpoint default jika diperlukan
    }
